...
?>
    ...
    <div class="container-fluid">
        <div class="row border-outline">
            <div class="col-3 border-outline">
                <form method="POST" action="submission_processing.php"> <!--Needs action attr.-->
                    ...
                    <div id="program_hidden_div" class="hidden_div">
                        <fieldset>
                            ...
                            <input type="radio" name="newProgramOutreach" id="newOutreachNo" value="no"
                                   checked="checked"><br>
                    ...
                    <div id="fundingSource_hidden_div" class="hidden_div">
                        <fieldset>
                            ...
                            <p>Reminder: If a funding source is renewed from year to year, consider adding the year to
                                the
                                funding
                    ...
                    <!-- Confirmation Modal -->
                    <div id="confirm-modal" class="modal" tabindex="-1" role="dialog" aria-labelledby="finalize-modal"
                         aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <input id="submit-entry" class="btn btn-primary" name="submission" type="submit"
                                           value="Submit">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal"
                                            onclick="resetErrors()">Cancel
                                    </button>
                                </div>
                            </div>
                        </div>
